...
# Added the green color to setup function and changed the default text color to green. No other differences between the original termdown.
...
def draw_text(stdscr, text, color=5, fallback=None, title=None, no_figlet_y_offset=-1, end=None):
    """
